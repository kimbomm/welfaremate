...
export const INCOME_OPTIONS = [
  { value: "low", label: "중위소득 50% 이하", description: "1인 기준 약 111만원 이하" },
  { value: "medium", label: "중위소득 50~100%", description: "1인 기준 약 111~222만원" },
  { value: "high", label: "중위소득 100% 초과", description: "1인 기준 약 222만원 초과" },
] as const;

export const HOUSEHOLD_OPTIONS = [
  { value: "single", label: "1인 가구" },
  { value: "married", label: "기혼 (배우자 있음)" },
  { value: "with-parents", label: "부모님과 동거" },
  { value: "other", label: "기타" },
] as const;
...
export const HOUSING_OPTIONS = [
  ...
  { value: "own", label: "자가" },
  { value: "with-parents", label: "부모님 집" },
  { value: "other", label: "기타" },
] as const;
